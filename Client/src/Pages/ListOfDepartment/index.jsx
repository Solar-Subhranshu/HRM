...
//     setSelectedDepartmentId(selectedDepartmentId === id ? '' : id);
//   };
...
//       alert('Please select a designation to update.');
//       return;
//     }
...
//               designationNameData.map(({ designation, id }) => (
//                 <tr key={id}>
//                   <td className="border-t border-gray-300 flex justify-center items-center align-middle">
//                     <input
//                       type="checkbox"
//                       checked={selectedDesignationId === id}
//                       onChange={() => setSelectedDesignationId(id)}
//                     />
//                   </td>
