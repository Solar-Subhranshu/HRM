      ...
      <div className="h-screen px-8 pt-4 bg-gray-100">
        <fieldset className="border-4 rounded-md mb-4" style={{ borderColor: "#740FD6" }}>
          ...
          <div className="flex flex-col md:flex-row">
            ...
            {/* First Column */}
            <div className="md:w-80 border-r border-gray-300 p-4">
              ...
              <div className="mt-4">
                <div className="flex items-center gap mb-2">
                  ...
                  <div className="mb-4">
                    ...
                    <select 
                      className="mt-2 block w-full rounded-md border-2 border-gray-300 p-2 focus:outline-none focus:ring-2 focus:ring-purple-500"
                ...
                <div className="relative mt-4">
                  <span className="absolute mt-3 left-3 flex items-center text-gray-400">
                      ...
                      <table className="table-auto w-full border-collapse border border-gray-500">
                        <tbody>
                          {filteredEmployees.map(({ _id, name,employeeCode, shift }) => (
                            <tr key={_id}>
                              <td className=" border border-gray-300  w-10 text-center items-center align-middle h-8" style={{width : 'max-width'}}>
                                <input
                                  type="checkbox"
                              ...
                              <td className="border border-gray pl-2">{name}({employeeCode})</td>
                            </tr>
                          ))}
                        </tbody>
                      </table>
                ...
                <fieldset className="border-2 rounded-md mb-4" style={{ borderColor: "#740FD6" }}>
                  ...
                  <div className="grid gap-6 m-6 md:grid-cols-3">
                    ...
                    <div>
                      ...
                      <input
                        type="date"
                        className="w-full rounded-md border py-2 px-4 focus:outline-none focus:ring-2 focus:ring-purple-500"
                      />
                    </div>
                    {/* In Time Field */}
                    <div>
                  ...
                  <table className="w-full border-collapse border border-gray-300 text-sm text-center">
                    <thead>
                      <tr className="bg-gray-200">
                        ...
                        <th className="border border-gray-300 px-2 py-1"> Emp. Code</th>
                        <th className="border border-gray-300 px-2 py-1">Department</th>
                        <th className="border border-gray-300 px-2 py-1">Punch DateTime</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr>
                        ...
                        <td className="border border-gray-300 px-2 py-1">430</td>
                        <td className="border border-gray-300 px-2 py-1">Infra Team</td>
                        <td className="border border-gray-300 px-2 py-1">Jan 7 2025</td>
                      </tr>
                    </tbody>
                  </table>
                </div>
