...
const ShiftDetailsTable =()=> {
    const [weekDayName, setWeekDayName]=useState(["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday" , "Sunday"]);
  return (
    <div className='flex flex-col justify-between gap-8'>
        ...
        <div className='grid grid-cols-4 gap-4 mt-4'>
            ...
            <div className='flex flex-col'>
                <label className='pb-2'>
                    <span className='pl-8'>Shift Start Time</span>
                    <span className='text-red-600'>*</span>
                </label>
            ...
            <div className='flex flex-col'>
                <label className='pb-2'>
                    <span className='pl-8'>Shift End time</span>
                </label>
                <div className='ml-8  mr-20 flex justify-between items-center rounded-md border-2 py-1 px-2 focus:outline-none focus:ring-2 focus:ring-black'>
                   {<TimeSelector/>}
                   {<IoIosTimer size={24} />}
        ...
        <div className='ml-2 mr-2'>
            ...
            <div className='flex flex-col'>
                <div className='flex flex-col'>
                    <span className='ml-8 pb-2'>Select Week-off</span>
                </div>
                <select className="ml-8 mr-20 rounded-md border-2 py-2 px-2 focus:outline-none focus:ring-2 focus:ring-black">
            ...
            <div className='flex flex-col'>
                ...
                <div className='flex flex-col'>
                    <span className='ml-8 pb-2'>Max Early Allowed</span>
                </div>
                <div className='ml-8  mr-20 flex justify-between items-center rounded-md border-2 py-1 px-2 focus:outline-none focus:ring-2 focus:ring-black'>
                   {<TimeSelector/>}
                   {<IoIosTimer size={24} />}
            ...
            <div className='flex flex-col'>
                <div className='flex flex-col'>
                    <span className='ml-8 pb-2'>Max Late Allowed</span>
                </div>
                <div className='ml-8  mr-20 flex justify-between items-center rounded-md border-2 py-1 px-2 focus:outline-none focus:ring-2 focus:ring-black'>
                   {<TimeSelector/>}
                   {<IoIosTimer size={24} />}
