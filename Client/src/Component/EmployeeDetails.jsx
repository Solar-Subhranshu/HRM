...
//     console.log(getEmployeeDetailsData);
//     return (
        
//         <div className="flex flex-wrap p-6 bg-gray-50">
//              <pre>{JSON.stringify(getEmployeeDetailsData)}</pre>  
...
//                 </div>
//                 <div className="flex justify-between mt-4">
//                     <p className="text-lg font-semibold text-gray-800">Company Email Id:</p>
...
//                     <span className="font-normal">{getEmployeeDetailsData.joiningDate}</span>
//                 </div>
//                 <div className="flex justify-between mt-4">
...
//                 </div>
//                 <div className="flex justify-between mt-4">
//                     <p className="text-lg font-semibold text-gray-800">Resign Date:</p>
//                     <span className="font-normal">{getEmployeeDetailsData.father_husbandName}</span>
//                 </div>
//                 <div className="flex justify-between mt-4">
//                     <p className="text-lg font-semibold text-gray-800">Office Time Policy:</p>
//                     <span className="font-normal">{getEmployeeDetailsData.father_husbandName}</span>
//                 </div>
//                 <div className="flex justify-between mt-4">
...
//                 </div>
//                 <div className="flex justify-between mt-4">
//                     <p className="text-lg font-semibold text-gray-800">Designation:</p>
//                     <span className="font-normal">{getEmployeeDetailsData.designation.designation}</span>
//                 </div>
//                 <div className="flex justify-between mt-4">
//                     <p className="text-lg font-semibold text-gray-800">Shift:</p>
//                     <span className="font-normal">{getEmployeeDetailsData.father_husbandName}</span>
//                 </div>
//             </div>
//         </div>
