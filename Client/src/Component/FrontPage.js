...
// import Header from '../Component/TopNavBar/index';
...
function FrontPage() {
    ...
    return (
        <div className="h-screen static">
                    ...
                    <div className="bg-white p-8 rounded-lg shadow-xl w-full sm:w-96" style={{ marginTop: -40 }}>
                        <form method="post" onSubmit={handleSubmit}>
                            ...
                            <div className="w-full">
                                <button
                                    type="submit"
                                    className="w-full bgMainColor hover:bg-red-700 text-white font-semibold py-2 px-4 rounded-lg shadow-md transition-colors duration-300"
                                >
                                    Login
                                </button>
                            </div>
            ...
            {/* Footer part */}
            <div className="bgMainColor absolute bottom-0 left-0 w-screen h-12"></div>
        </div>
    );
}
